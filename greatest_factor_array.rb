...
# create a helper method to calculate greatest_factor given an even number
# iterate through arr
# if number is even, invoke greatest_factor and shovel that result new_array
# if number is odd, just shovel it to new_array
